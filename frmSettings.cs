...
namespace I101DocumentViewer
{
    public partial class frmSettings
    {
        ...
        //private readonly Dictionary<PdfRasterizerEngine, string> _renderingEngines = new Dictionary<PdfRasterizerEngine, string>
        //{
        ...
        private void frmSettings_Load(object sender, EventArgs e)
        {
            ...
            //foreach (var item in _renderingEngines)
            //{
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            ...
            //_owner.PdfRasterizerEngine = _renderingEngines.FirstOrDefault(x => x.Value.Contains(cbPDFRenderingEngine.SelectedItem.ToString())).Key;
